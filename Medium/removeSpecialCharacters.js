...
//My answer
const removeSpecialCharacters = str => str.replace(/[!@#$%^&*(),.?":{}|<>_\[\]]/g, '');

//Better answer I did not understand the not operator ^ for regExp
const removeSpecialCharacters = str =>  str.replace(/[^\w- ]/gi, "");