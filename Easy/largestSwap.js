...
the digits gives us 72, and 72 > 27. On the other hand, swapping 
...
largestSwap(99) ➞ true
Notes
Numbers with two identical digits (third example) should yield 
true (you can't do better).
...
let largestSwap = (num) => {
	...
	if(num > reverseNum || num === reverseNum) {
		return true;
	} else {
		return false;
	}
